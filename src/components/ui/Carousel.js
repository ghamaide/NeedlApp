      ...
      <View ref='view' style={[{position: 'relative', backgroundColor: 'transparent'}, this.props.style]} onLayout={(e) => {
        ...
        {this.state.width ?
         ...
         {canGoBack ?
          ...
          onPress={this.goBackward}>
              <Image style={[styles.fleche, styles.flecheLeft]} source={require('../../assets/images/icons/arrow.png')} />
          </TouchableOpacity>
          : null}
        ...
        {canGoForward ?
          ...
          onPress={this.goForward}>
              <Image style={[styles.fleche]} source={require('../../assets/images/icons/arrow.png')} />
          </TouchableOpacity>
          : null}
      </View>
    );
